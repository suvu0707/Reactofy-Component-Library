...
exports.useCalculatedColumnswithIdx = useCalculatedColumnswithIdx;
...
function useCalculatedColumnswithIdx(_ref) {
  let {
    rowData1
  } = _ref;
  const {
    ...
    var columns4 = rowData1.map((rawColumn, pos) => {
      const column = _objectSpread({}, rawColumn);
      column.idx = pos;
