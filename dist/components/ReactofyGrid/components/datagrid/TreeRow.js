...
function TreeRow(_ref) {
  ...
  (0, _react.useEffect)(() => {
    ...
    function recursiveChild(obj, level) {
      ...
      level = level + 1;
      (_obj$children = obj.children) === null || _obj$children === void 0 || _obj$children.map(childObj => {
    ...
    sourceData === null || sourceData === void 0 || sourceData.map(data => {
      let level = 0;
      if (data.children) {
...
var _default = exports.default = /*#__PURE__*/(0, _react.memo)(TreeRow);