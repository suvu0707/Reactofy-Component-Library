...
function Cell(_ref) {
  ...
  function handleClick(e) {
    ...
    onCellClick === null || onCellClick === void 0 || onCellClick({
      api: api,
      colDef: {
        field: column.field,
  ...
  function handleContextMenu(e) {
    ...
    selectCellWrapper();
    onCellContextMenu === null || onCellContextMenu === void 0 || onCellContextMenu({
      api: api,
      colDef: {
        field: column.field,
  ...
  function handleDoubleClick(e) {
    ...
    onRowDoubleClick === null || onRowDoubleClick === void 0 || onRowDoubleClick({
      api: api,
      data: row,
      columnApi: columnApi,
      node: node,
    ...
    onCellDoubleClick === null || onCellDoubleClick === void 0 || onCellDoubleClick({
      api: api,
      colDef: {
        field: column.field,
